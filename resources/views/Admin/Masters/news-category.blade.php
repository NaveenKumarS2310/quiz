                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('admin.news.category.edit.store') }}" method="POST">
                         @else
                         <form class="forms-sample" action="{{ route('admin.news.category.create.store') }}" method="POST">
                         @endif
                            @csrf
                            ...
                            <tbody>
                                @foreach ($categories as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.news.category.edit.index',['id' => $data->id]) }}"><button type="button" class="btn btn-gradient-info btn-fw">Edit</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
