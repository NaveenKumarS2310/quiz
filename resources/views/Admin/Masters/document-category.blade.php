                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if (request()->route()->getName() == 'admin.document.category.edit.index')
                            <form class="forms-sample" action="{{ route('admin.document.category.edit.store') }}"
                                method="POST" enctype="multipart/form-data">
                            @else
                                <form class="forms-sample" action="{{ route('admin.document.category.create.store') }}"
                                    method="POST" enctype="multipart/form-data">
                        @endif
                        @csrf
                            ...
                            <tbody>
                                @foreach ($categories as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a
                                                href="{{ route('admin.document.category.edit.index', ['id' => $data->id]) }}"><button
