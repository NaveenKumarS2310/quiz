...
use App\Http\Controllers\Admin\InterviewTestController;
...
Route::middleware('basic.auth')->group(function () {
  ...
  Route::middleware('check.if.admin.or.editor')->group(function () {
    ...
    Route::prefix('uploads')->group(function () {
      ...
      //   test upload
      Route::get('free-quiz/index', [TestUploadController::class, 'index'])->name('upload.free-quiz.index');
      Route::post('free-quiz/store', [TestUploadController::class, 'store'])->name('upload.free-quiz.store');
      Route::get('/admin/uploads/free-quiz/edit/{id}', [TestUploadController::class, 'edit'])->name('upload.free-quiz.edit');
      Route::post('/admin/uploads/free-quiz/question-save/{id}', [TestUploadController::class, 'question_save'])->name('upload.free-quiz.question.save');
      Route::get('/free-quiz', [TestUploadController::class, 'free_quiz'])->name('upload.free-quiz');
      //   interview test upload
      Route::get('free-interview', [InterviewTestController::class, 'index'])->name('upload.free-interview.index');
      Route::get('free-interview/create', [InterviewTestController::class, 'create'])->name('upload.free-interview.create');
      Route::post('free-interview/store', [InterviewTestController::class, 'store'])->name('upload.free-interview.store');
      Route::get('/admin/uploads/free-interview/edit/{id}', [InterviewTestController::class, 'edit'])->name('upload.free-interview.edit');
      Route::post('/admin/uploads/free-interview/question-save/{id}', [InterviewTestController::class, 'question_save'])->name('upload.free-interview.question.save');
    });
