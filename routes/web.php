...
Route::get('/quiz_category/{slug}', [QuizController::class, 'quiz_category']);
Route::get('/quiz/{slug}', [QuizController::class, 'quiz_overview']);
Route::get('/quiz_start/{quiz_id}/', [QuizController::class, 'quiz_start']);
Route::get('/quiz/{slug}/{qust_no}', [QuizController::class, 'qustion_view']);
Route::post('/quiz/{slug}/qustion_submit', [QuizController::class, 'single_qustion_submit']);
